...
test.describe('File Preview', () => {
  ...
  test.describe('Code tab', () => {
    test('Code tab shows raw file content', async ({ page }) => {
      ...
      await expect(page.getByText('ClawdView Test Fixture').first()).toBeVisible();
    });
  ...
  test.describe('Python execution', () => {
    test('clicking Run executes the script and shows output', async ({ page }) => {
      ...
      // The fixture script prints "Hello, ClawdView!" and "Fixture script complete."
      await expect(page.getByText('Hello, ClawdView!').first()).toBeVisible();
    });
  });
});
